...
import {
  Archive, ArrowUpRight, BookOpen, Check, ChevronLeft, ClipboardList, Copy, ExternalLink, FileText,
...
function ImageStrip({ images, onPreview }: { images: HannaImageResult[]; onPreview?: (image: HannaImageResult) => void }) {
