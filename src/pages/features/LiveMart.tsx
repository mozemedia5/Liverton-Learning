...
const products = [
  ...
  { name: 'Design thinking lesson pack', seller: 'Alex Smith · Educator', price: '$12', rating: '5.0', category: 'Lesson packs', color: '#8de5dc' },
