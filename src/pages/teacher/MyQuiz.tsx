/**
 * My Quiz Page - Teacher Dashboard
 * Displays all quizzes created by the teacher with integrated analytics
 * Allows teachers to track their quiz performance and student engagement
 */
      ...
      <div className="p-4 lg:p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Track and manage all your quizzes</p>
          </div>
          <Button
