...
export const DEFAULT_DESCRIPTION =
  'Liverton Learning is the modern learning platform for students, educators, families, and education organizations: courses, live lessons, quizzes, collaborative Liv Teams workspaces, documents, and AI-powered study help.';
