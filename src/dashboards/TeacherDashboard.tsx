...
const quickActions = [
  ...
  { label: 'Create Short', icon: Video, path: '/features/tearn/shorts' },
...
export default function TeacherDashboard() {
  ...
  return <div className="liv-page">
    ...
    <div className="liv-grid-2" style={{ marginTop: 14 }}><section className="liv-card"><div className="liv-section-head" style={{ marginTop: 0 }}><h2>Learning activity</h2><button onClick={() => navigate('/teacher/courses')}>See modules</button></div><div className="liv-list"><div className="liv-list-row"><span className="liv-row-icon"><BarChart3 size={17} /></span><div><h3>Live module analytics</h3><p>Open a module to review learners, lessons, assignments, and quizzes.</p></div></div><div className="liv-list-row"><span className="liv-row-icon"><Clock3 size={17} /></span><div><h3>Dates reflect saved timestamps</h3><p>Displayed using the browser’s current locale.</p></div></div></div></section><section className="liv-card"><div className="liv-section-head" style={{ marginTop: 0 }}><h2>Collaboration desk</h2><button onClick={() => navigate('/features/liv-teams')}>Open Teams</button></div><div className="liv-list"><div className="liv-list-row"><span className="liv-row-icon"><Video size={17} /></span><div><h3>Create a lesson Short</h3><p>Link discovery content to its exact module or lesson.</p></div><span className="liv-row-end"><ArrowUpRight size={15} /></span></div><div className="liv-list-row"><span className="liv-row-icon"><Users size={17} /></span><div><h3>Invite a co-creator</h3><p>Collaborate in Liv Teams and connect the team to a module.</p></div><span className="liv-row-end"><ChevronRight size={16} /></span></div></div></section></div>
  </div>;
}
